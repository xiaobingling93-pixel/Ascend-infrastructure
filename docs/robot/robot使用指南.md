...
| /approve | /approve | Pull Request | 添加用于代表committers同意合并的标签 approved。 | 仓库所属sig组的committers | 所有仓库 |
...
| /unassign [[@]...] | /assign <br> /assign @ascend-robot | Issue | 取消Issue指派的负责人。 | 所有人 | 所有仓库 |
