...
- sig_name: infrastructure        # SIG组
  ...
  meeting_creators:               # 会议申请人列表
    - account: tom_toworld        # 申请人的华为账号名，用于绑定创建会议的权限。可通过登录https://id1.cloud.huawei.com/AMW/portal/userCenter/index.html#/security 查看获取账号名
    - account: XXX
- sig_name: XXX2
...
![1761617883669](assets/1761617883669.png)
...
+ 邮件地址：填写需要通知参加会议的核心人员和邮件列表，以“；”间隔，最多20个邮件，超过20封建议。发送成功后可以在对应的邮件列表归档中查看此通知邮件，如果没有则存储拦截情况，请联系基础设施@drizzlezyk [zhongyuanke@huawei.com](mailto:zhongyuanke@huawei.com)处理。
